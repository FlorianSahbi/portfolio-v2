...
class NavBar extends Component {
    ...
    handleScroll() {
        this.setState({
            ...
            formationListPosY: document.getElementsByClassName('formationList')[0].offsetTop,
        ...
        if (y >= this.state.formationListPosY && y < this.state.currentJobPosY) {
            document.getElementsByClassName('navBarButtonFormationList')[0].classList.add("navBarActiveButton");
        } else {
            document.getElementsByClassName('navBarButtonFormationList')[0].classList.remove("navBarActiveButton");
        }
